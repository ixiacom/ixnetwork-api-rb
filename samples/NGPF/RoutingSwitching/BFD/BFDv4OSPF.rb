...
###########################################################################
puts("Adding BFDv4 and Configuring")
...
minRxInterval1 = @ixNet.getAttribute(bfdv41, '-txInterval')
minRxInterval2 = @ixNet.getAttribute(bfdv42, '-txInterval')
...
@ixNet.help('::ixNet::OBJ-/topology/deviceGroup/ethernet/ipv4/bfdv4Interface')

############################################################################
#Add and Configure OSPFv2
############################################################################
puts("Adding OSPF and Configuring")
...
@ixNet.help('::ixNet::OBJ-/topology/deviceGroup/ethernet/ipv4/ospfv2')
...
##On The Fly Section
############################################################################
puts("Deactivating and Activating BFDv4 Interface On the fly")
